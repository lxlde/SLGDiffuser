...
def initialize_model(config, ckpt,ckpt_unet):
...
sampler = initialize_model("../../configs/stable-diffusion/v2-inpainting-inference.yaml", "../../../stablediffusion-main/experiment/inpainting.ckpt","../../../stablediffusion-main/experiment/inpainting.ckpt")
